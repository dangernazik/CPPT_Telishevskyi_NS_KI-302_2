...
public abstract class AbstarctClimbingGear implements MilitaryAlpinist{
    //Поля класу
    private Shoes shoes;
    ...
    public AbstarctClimbingGear(){
        try {
            logWriter = new PrintWriter(new FileWriter("KI302/Telishevskyi/Lab2/climbing_log.txt"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public AbstarctClimbingGear(Shoes shoes, Clothes clothes, Rope rope){
        this.shoes = shoes;
        this.clothes = clothes;
        this.rope = rope;
        try {
            logWriter = new PrintWriter(new FileWriter("KI302/Telishevskyi/Lab3/climbing_log.txt"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public String toString() {
        return "ClimbingGear: " + shoes + ", " + clothes + ", " + rope;
    }
